...
public class RoadEnv extends Environment {
    // common literals
    public static final Literal ACQUIRE_PROCESSOR = Literal.parseLiteral("acquire(processor)");
    ...
    public static final Literal ACCEPT_DELIVERY_CAR = Literal.parseLiteral("accept_delivery(car)");
    public static final Literal HAS_CUSTOMER_CAR = Literal.parseLiteral("has(customer,car)");

    public static final Literal AT_RETAILER_PROCESSOR = Literal.parseLiteral("at(retailer,processor)");
    public static final Literal AT_RETAILER_CUSTOMER = Literal.parseLiteral("at(retailer,customer)");

    private static final Logger LOGGER = Logger.getLogger(RoadEnv.class.getName());
